...
try {
    ...
    $stmt = $db->prepare("SELECT m.*, u.username as author_name FROM memories m LEFT JOIN users u ON m.author_id = u.id $where ORDER BY m.event_time DESC LIMIT :limit OFFSET :offset");
